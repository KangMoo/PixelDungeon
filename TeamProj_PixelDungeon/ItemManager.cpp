...
void ItemManager::imgInit()
{
	...
	//=========================== E F F E C T  =============================
	IMAGEMANAGER->addImage("effectFire", "Img/Item/effect_fire.bmp", 10, 10, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("effectFrozen", "Img/Item/effect_snow.bmp", 10, 10, true, RGB(255, 0, 255));
